...
DEFAULT_SYSTEM_PROMPT = (
    ...
    "PATTERN ANALYSIS (AUTOMATIC DETECTION):\n"
    "- When queries ask about 'most common', 'frequent', 'patterns', 'influence', 'factors', 'why', 'what causes' → AUTOMATICALLY use BOTH tools:\n"
